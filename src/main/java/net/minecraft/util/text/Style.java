...
public class Style extends ChatStyle {
    ...
    public Style func_150206_m() {
        Style style = new Style();
        style.func_150227_a(this.func_150223_b());
        style.func_150217_b(this.func_150242_c());
        style.func_150225_c(this.func_150236_d());
        style.func_150228_d(this.func_150234_e());
        style.func_150237_e(this.func_150233_f());
